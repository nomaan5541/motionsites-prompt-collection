...
| 3 | **Hand Prosthesis Simulator** | HorizonX Library | [`motionsites-prompts/hx-hand-prosthesis-simulator`](motionsites-prompts/hx-hand-prosthesis-simulator) |
| 4 | **Zyno** | HorizonX Library | [`motionsites-prompts/hx-zyno`](motionsites-prompts/hx-zyno) |
| 5 | **Digital Wave Field Hero** | HorizonX Library | [`motionsites-prompts/hx-digital-wave-field-hero`](motionsites-prompts/hx-digital-wave-field-hero) |
| 6 | **EIDOLON Monolith Hero** | HorizonX Library | [`motionsites-prompts/hx-eidolon-monolith-hero`](motionsites-prompts/hx-eidolon-monolith-hero) |
| 7 | **Lunarix One** | HorizonX Library | [`motionsites-prompts/hx-lunarix-one`](motionsites-prompts/hx-lunarix-one) |
| 8 | **Gallery Ring — Interactive 3D Showcase** | HorizonX Library | [`motionsites-prompts/hx-halo-ring`](motionsites-prompts/hx-halo-ring) |
| 9 | **All in one** | HorizonX Library | [`motionsites-prompts/hx-all-in-one`](motionsites-prompts/hx-all-in-one) |
| 10 | **Car Showroom** | HorizonX Library | [`motionsites-prompts/hx-car-showroom`](motionsites-prompts/hx-car-showroom) |
| 11 | **Vortex** | HorizonX Library | [`motionsites-prompts/hx-vortex`](motionsites-prompts/hx-vortex) |
| 12 | **ARC0050** | HorizonX Library | [`motionsites-prompts/hx-arc0050`](motionsites-prompts/hx-arc0050) |
| 13 | **Good Move** | HorizonX Library | [`motionsites-prompts/hx-good-move`](motionsites-prompts/hx-good-move) |
| 14 | **VOLTARA** | HorizonX Library | [`motionsites-prompts/hx-voltara`](motionsites-prompts/hx-voltara) |
| 15 | **Hemlt** | HorizonX Library | [`motionsites-prompts/hx-hemlt`](motionsites-prompts/hx-hemlt) |
| 16 | **PULSO** | HorizonX Library | [`motionsites-prompts/hx-pulso`](motionsites-prompts/hx-pulso) |
| 17 | **VIBRAM** | HorizonX Library | [`motionsites-prompts/hx-vibram`](motionsites-prompts/hx-vibram) |
| 18 | **Pink Fluffy** | HorizonX Library | [`motionsites-prompts/hx-pink-fluffy`](motionsites-prompts/hx-pink-fluffy) |
| 19 | **Personal** | HorizonX Library | [`motionsites-prompts/hx-personal`](motionsites-prompts/hx-personal) |
| 20 | **TOLVA Roasters** | HorizonX Library | [`motionsites-prompts/hx-tolva-roasters`](motionsites-prompts/hx-tolva-roasters) |
| 21 | **Rabbit** | HorizonX Library | [`motionsites-prompts/hx-rabbit`](motionsites-prompts/hx-rabbit) |
| 22 | **Kronos** | HorizonX Library | [`motionsites-prompts/hx-kronos`](motionsites-prompts/hx-kronos) |
| 23 | **Luminous Topo** | HorizonX Library | [`motionsites-prompts/hx-luminous-topo`](motionsites-prompts/hx-luminous-topo) |
| 24 | **Veyra** | HorizonX Library | [`motionsites-prompts/hx-veyra`](motionsites-prompts/hx-veyra) |
| 25 | **REALY** | HorizonX Library | [`motionsites-prompts/hx-realy`](motionsites-prompts/hx-realy) |
| 26 | **Facial Fusion** | HorizonX Library | [`motionsites-prompts/hx-facial-fusion`](motionsites-prompts/hx-facial-fusion) |
| 27 | **Moss Terrain Colorways** | HorizonX Library | [`motionsites-prompts/hx-moss-terrain-colorways`](motionsites-prompts/hx-moss-terrain-colorways) |
| 28 | **CoverFlow Carousel** | HorizonX Library | [`motionsites-prompts/hx-coverflow-carousel`](motionsites-prompts/hx-coverflow-carousel) |
| 29 | **Beaded Deer Sunset** | HorizonX Library | [`motionsites-prompts/hx-beaded-deer-sunset`](motionsites-prompts/hx-beaded-deer-sunset) |
| 30 | **STRYX Brand System** | HorizonX Library | [`motionsites-prompts/hx-stryx-brand-system`](motionsites-prompts/hx-stryx-brand-system) |
| 31 | **Neon Pricing** | HorizonX Library | [`motionsites-prompts/hx-neon-pricing`](motionsites-prompts/hx-neon-pricing) |
| 32 | **AERON NeoShell Hero** | HorizonX Library | [`motionsites-prompts/hx-aeron-neoshell-hero`](motionsites-prompts/hx-aeron-neoshell-hero) |
| 33 | **Interactive Carousel** | HorizonX Library | [`motionsites-prompts/hx-interactive-carousel`](motionsites-prompts/hx-interactive-carousel) |
| 34 | **Golden Pixel Horse** | HorizonX Library | [`motionsites-prompts/hx-golden-pixel-horse`](motionsites-prompts/hx-golden-pixel-horse) |
| 35 | **Verve** | HorizonX Library | [`motionsites-prompts/hx-verve`](motionsites-prompts/hx-verve) |
| 36 | **GSAP Scroll Motion Lab** | HorizonX Library | [`motionsites-prompts/hx-gsap-scroll-motion-lab`](motionsites-prompts/hx-gsap-scroll-motion-lab) |
| 37 | **Time Machine Stack** | HorizonX Library | [`motionsites-prompts/hx-time-machine-stack`](motionsites-prompts/hx-time-machine-stack) |
| 38 | **Beaded Palace** | HorizonX Library | [`motionsites-prompts/hx-beaded-palace`](motionsites-prompts/hx-beaded-palace) |
| 39 | **NTX** | HorizonX Library | [`motionsites-prompts/hx-ntx`](motionsites-prompts/hx-ntx) |
| 40 | **Cookie Consent Ideas** | HorizonX Library | [`motionsites-prompts/hx-cookie-consent`](motionsites-prompts/hx-cookie-consent) |
| 41 | **Noctuary** | HorizonX Library | [`motionsites-prompts/hx-noctuary`](motionsites-prompts/hx-noctuary) |
| 42 | **Cottage Meadow** | HorizonX Library | [`motionsites-prompts/hx-cottage-meadow`](motionsites-prompts/hx-cottage-meadow) |
| 43 | **Cybertruck** | HorizonX Library | [`motionsites-prompts/hx-cybertruck`](motionsites-prompts/hx-cybertruck) |
| 44 | **ELLISON** | HorizonX Library | [`motionsites-prompts/hx-ellison`](motionsites-prompts/hx-ellison) |
| 45 | **Cool Wave Layers** | HorizonX Library | [`motionsites-prompts/hx-cool-wave-layers`](motionsites-prompts/hx-cool-wave-layers) |
| 46 | **VitalSync** | HorizonX Library | [`motionsites-prompts/hx-vitalsync`](motionsites-prompts/hx-vitalsync) |
| 47 | **Cinderline** | HorizonX Library | [`motionsites-prompts/hx-cinderline`](motionsites-prompts/hx-cinderline) |
| 48 | **Iris Meadow** | HorizonX Library | [`motionsites-prompts/hx-iris-meadow`](motionsites-prompts/hx-iris-meadow) |
| 49 | **Card** | HorizonX Library | [`motionsites-prompts/hx-card`](motionsites-prompts/hx-card) |
| 50 | **KIVRA** | HorizonX Library | [`motionsites-prompts/hx-kivra`](motionsites-prompts/hx-kivra) |
| 51 | **Zen Garden** | HorizonX Library | [`motionsites-prompts/hx-zen-garden`](motionsites-prompts/hx-zen-garden) |
| 52 | **Finance App** | HorizonX Library | [`motionsites-prompts/hx-finance-app`](motionsites-prompts/hx-finance-app) |
| 53 | **Wildflower Meadow** | HorizonX Library | [`motionsites-prompts/hx-wildflower-meadow`](motionsites-prompts/hx-wildflower-meadow) |
| 54 | **Natural App** | HorizonX Library | [`motionsites-prompts/hx-natural-app`](motionsites-prompts/hx-natural-app) |
| 55 | **Coral Soft Dunes Terrain** | HorizonX Library | [`motionsites-prompts/hx-coral-soft-dunes-terrain`](motionsites-prompts/hx-coral-soft-dunes-terrain) |
| 56 | **Mosk** | HorizonX Library | [`motionsites-prompts/hx-mosk`](motionsites-prompts/hx-mosk) |
| 57 | **Purple Coral Waves** | HorizonX Library | [`motionsites-prompts/hx-purple-coral-waves`](motionsites-prompts/hx-purple-coral-waves) |
| 58 | **Future 2.0** | HorizonX Library | [`motionsites-prompts/hx-future-2`](motionsites-prompts/hx-future-2) |
| 59 | **Soft Meadow** | HorizonX Library | [`motionsites-prompts/hx-pastoral-meadow`](motionsites-prompts/hx-pastoral-meadow) |
| 60 | **Legion Age** | HorizonX Library | [`motionsites-prompts/hx-legion-age`](motionsites-prompts/hx-legion-age) |
| 61 | **Fine Jewelry** | HorizonX Library | [`motionsites-prompts/hx-fine-jewelry`](motionsites-prompts/hx-fine-jewelry) |
| 62 | **Medlio** | HorizonX Library | [`motionsites-prompts/hx-medlio`](motionsites-prompts/hx-medlio) |
| 63 | **Alpine Lake** | HorizonX Library | [`motionsites-prompts/hx-alpine-lake`](motionsites-prompts/hx-alpine-lake) |
| 64 | **Nissan** | HorizonX Library | [`motionsites-prompts/hx-nissan`](motionsites-prompts/hx-nissan) |
| 65 | **Bakery Packaging** | HorizonX Library | [`motionsites-prompts/hx-bakery-packaging`](motionsites-prompts/hx-bakery-packaging) |
| 66 | **Oppo** | HorizonX Library | [`motionsites-prompts/hx-oppo`](motionsites-prompts/hx-oppo) |
| 67 | **Spirits Cellar** | HorizonX Library | [`motionsites-prompts/hx-spirits-cellar`](motionsites-prompts/hx-spirits-cellar) |
| 68 | **Digital Money** | HorizonX Library | [`motionsites-prompts/hx-digital-money`](motionsites-prompts/hx-digital-money) |
| 69 | **Sky Cloudscape** | HorizonX Library | [`motionsites-prompts/hx-sky-cloudscape`](motionsites-prompts/hx-sky-cloudscape) |
| 70 | **ECCO** | HorizonX Library | [`motionsites-prompts/hx-ecco`](motionsites-prompts/hx-ecco) |
| 71 | **Sculptural Lighting** | HorizonX Library | [`motionsites-prompts/hx-sculptural-lighting`](motionsites-prompts/hx-sculptural-lighting) |
| 72 | **ICHIBAN** | HorizonX Library | [`motionsites-prompts/hx-ichiban`](motionsites-prompts/hx-ichiban) |
| 73 | **Mountain Lake** | HorizonX Library | [`motionsites-prompts/hx-mountain-lake`](motionsites-prompts/hx-mountain-lake) |
| 74 | **Waaw** | HorizonX Library | [`motionsites-prompts/hx-waaw`](motionsites-prompts/hx-waaw) |
| 75 | **Charcoal Mesa Cliff Terrain** | HorizonX Library | [`motionsites-prompts/hx-charcoal-mesa-cliff-terrain`](motionsites-prompts/hx-charcoal-mesa-cliff-terrain) |
| 76 | **Logitech** | HorizonX Library | [`motionsites-prompts/hx-logitech`](motionsites-prompts/hx-logitech) |
| 77 | **Premium Audio** | HorizonX Library | [`motionsites-prompts/hx-premium-audio`](motionsites-prompts/hx-premium-audio) |
| 78 | **Rayban** | HorizonX Library | [`motionsites-prompts/hx-rayban`](motionsites-prompts/hx-rayban) |
| 79 | **Atelier Sneakers** | HorizonX Library | [`motionsites-prompts/hx-atelier-sneakers`](motionsites-prompts/hx-atelier-sneakers) |
| 80 | **Ally** | HorizonX Library | [`motionsites-prompts/hx-ally`](motionsites-prompts/hx-ally) |
| 81 | **Atelier Watch** | HorizonX Library | [`motionsites-prompts/hx-lux-watch-imagery`](motionsites-prompts/hx-lux-watch-imagery) |
| 82 | **Dune** | HorizonX Library | [`motionsites-prompts/hx-dune`](motionsites-prompts/hx-dune) |
| 83 | **Fragrance Maison** | HorizonX Library | [`motionsites-prompts/hx-fragrance-maison`](motionsites-prompts/hx-fragrance-maison) |
| 84 | **Atomic** | HorizonX Library | [`motionsites-prompts/hx-atomic`](motionsites-prompts/hx-atomic) |
| 85 | **Epic Valley** | HorizonX Library | [`motionsites-prompts/hx-epic-valley`](motionsites-prompts/hx-epic-valley) |
| 86 | **Cyberdog** | HorizonX Library | [`motionsites-prompts/hx-cyberdog`](motionsites-prompts/hx-cyberdog) |
| 87 | **Coastal Lighthouse** | HorizonX Library | [`motionsites-prompts/hx-coastal-lighthouse`](motionsites-prompts/hx-coastal-lighthouse) |
| 88 | **Nvidia** | HorizonX Library | [`motionsites-prompts/hx-nvidia`](motionsites-prompts/hx-nvidia) |
| 89 | **Forest Soft Dunes Terrain** | HorizonX Library | [`motionsites-prompts/hx-forest-soft-dunes-terrain`](motionsites-prompts/hx-forest-soft-dunes-terrain) |
| 90 | **Pricing Component** | HorizonX Library | [`motionsites-prompts/hx-pricing-component`](motionsites-prompts/hx-pricing-component) |
| 91 | **Olive Bowl Terrain** | HorizonX Library | [`motionsites-prompts/hx-olive-bowl-terrain`](motionsites-prompts/hx-olive-bowl-terrain) |
| 92 | **Juicy Fres** | HorizonX Library | [`motionsites-prompts/hx-juicy-fres`](motionsites-prompts/hx-juicy-fres) |
| 93 | **Teal Alpine Ridges Terrain** | HorizonX Library | [`motionsites-prompts/hx-teal-alpine-ridges-terrain`](motionsites-prompts/hx-teal-alpine-ridges-terrain) |
...
| 3 | **Heximage (by arifuzzamanmoin)** | 21st.dev Registry | [`motionsites-prompts/dev21-arifuzzamanmoin-heximage`](motionsites-prompts/dev21-arifuzzamanmoin-heximage) |
| 4 | **Ai Agent Pipeline (by dani_0212bfb0)** | 21st.dev Registry | [`motionsites-prompts/dev21-dani_0212bfb0-ai-agent-pipeline`](motionsites-prompts/dev21-dani_0212bfb0-ai-agent-pipeline) |
| 5 | **Neon Nebula (by karthiksivacharan)** | 21st.dev Registry | [`motionsites-prompts/dev21-karthiksivacharan-neon-nebula`](motionsites-prompts/dev21-karthiksivacharan-neon-nebula) |
| 6 | **All About The Benjamins (by anonbreadwinner)** | 21st.dev Registry | [`motionsites-prompts/dev21-anonbreadwinner-all-about-the-benjamins`](motionsites-prompts/dev21-anonbreadwinner-all-about-the-benjamins) |
| 7 | **Nm (by nblairwalker)** | 21st.dev Registry | [`motionsites-prompts/dev21-nblairwalker-nm`](motionsites-prompts/dev21-nblairwalker-nm) |
| 8 | **M Ascii (by nblairwalker)** | 21st.dev Registry | [`motionsites-prompts/dev21-nblairwalker-m-ascii`](motionsites-prompts/dev21-nblairwalker-m-ascii) |
| 9 | **N Ascii (by nblairwalker)** | 21st.dev Registry | [`motionsites-prompts/dev21-nblairwalker-n-ascii`](motionsites-prompts/dev21-nblairwalker-n-ascii) |
| 10 | **Portfolio (by ricaelmenezes3)** | 21st.dev Registry | [`motionsites-prompts/dev21-ricaelmenezes3-portfolio`](motionsites-prompts/dev21-ricaelmenezes3-portfolio) |
| 11 | **Container Scroll Animation (by user_aceternity)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_aceternity-container-scroll-animation`](motionsites-prompts/dev21-user_aceternity-container-scroll-animation) |
| 12 | **Scroll Expansion Hero (by user_2wfnj4jcSPR8JWRk7tpzrihdDV8)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2wfnj4jcSPR8JWRk7tpzrihdDV8-scroll-expansion-hero`](motionsites-prompts/dev21-user_2wfnj4jcSPR8JWRk7tpzrihdDV8-scroll-expansion-hero) |
| 13 | **Splite (by user_2nElBLvklOKlAURm6W1PTu6yYFh)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2nElBLvklOKlAURm6W1PTu6yYFh-splite`](motionsites-prompts/dev21-user_2nElBLvklOKlAURm6W1PTu6yYFh-splite) |
| 14 | **Spotlight Card (by easemize)** | 21st.dev Registry | [`motionsites-prompts/dev21-easemize-spotlight-card`](motionsites-prompts/dev21-easemize-spotlight-card) |
| 15 | **Radial Orbital Timeline (by user_2ra80vx0iKMyQWJ5AESmNfFbCHD)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2ra80vx0iKMyQWJ5AESmNfFbCHD-radial-orbital-timeline`](motionsites-prompts/dev21-user_2ra80vx0iKMyQWJ5AESmNfFbCHD-radial-orbital-timeline) |
| 16 | **Testimonials Columns 1 (by user_2tWTE0rCrloVAVylFPYfp10xU92)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2tWTE0rCrloVAVylFPYfp10xU92-testimonials-columns-1`](motionsites-prompts/dev21-user_2tWTE0rCrloVAVylFPYfp10xU92-testimonials-columns-1) |
| 17 | **Background Paths (by user_2rQ1QHrJyxpmWMHhqhANzWMc64n)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-background-paths`](motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-background-paths) |
| 18 | **Animated Hero (by user_2nElBLvklOKlAURm6W1PTu6yYFh)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2nElBLvklOKlAURm6W1PTu6yYFh-animated-hero`](motionsites-prompts/dev21-user_2nElBLvklOKlAURm6W1PTu6yYFh-animated-hero) |
| 19 | **Display Cards (by user_Codehagen)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_Codehagen-display-cards`](motionsites-prompts/dev21-user_Codehagen-display-cards) |
| 20 | **Glowing Effect (by user_aceternity)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_aceternity-glowing-effect`](motionsites-prompts/dev21-user_aceternity-glowing-effect) |
| 21 | **Dotted Surface (by sshahaider)** | 21st.dev Registry | [`motionsites-prompts/dev21-sshahaider-dotted-surface`](motionsites-prompts/dev21-sshahaider-dotted-surface) |
| 22 | **Shader Animation (by designali-in)** | 21st.dev Registry | [`motionsites-prompts/dev21-designali-in-shader-animation`](motionsites-prompts/dev21-designali-in-shader-animation) |
| 23 | **Animated Shader Hero (by ravikatiyar162)** | 21st.dev Registry | [`motionsites-prompts/dev21-ravikatiyar162-animated-shader-hero`](motionsites-prompts/dev21-ravikatiyar162-animated-shader-hero) |
| 24 | **Background Paper Shaders (by muhammadnadeemmn9485134)** | 21st.dev Registry | [`motionsites-prompts/dev21-muhammadnadeemmn9485134-background-paper-shaders`](motionsites-prompts/dev21-muhammadnadeemmn9485134-background-paper-shaders) |
| 25 | **Web Gl Shader (by designali-in)** | 21st.dev Registry | [`motionsites-prompts/dev21-designali-in-web-gl-shader`](motionsites-prompts/dev21-designali-in-web-gl-shader) |
| 26 | **Animate Card Animation (by moazamtrade)** | 21st.dev Registry | [`motionsites-prompts/dev21-moazamtrade-animate-card-animation`](motionsites-prompts/dev21-moazamtrade-animate-card-animation) |
| 27 | **Animated Shader Background (by minhxthanh)** | 21st.dev Registry | [`motionsites-prompts/dev21-minhxthanh-animated-shader-background`](motionsites-prompts/dev21-minhxthanh-animated-shader-background) |
| 28 | **Shader Lines (by designali-in)** | 21st.dev Registry | [`motionsites-prompts/dev21-designali-in-shader-lines`](motionsites-prompts/dev21-designali-in-shader-lines) |
| 29 | **The Infinite Grid (by moazamtrade)** | 21st.dev Registry | [`motionsites-prompts/dev21-moazamtrade-the-infinite-grid`](motionsites-prompts/dev21-moazamtrade-the-infinite-grid) |
| 30 | **Shader Background (by minhxthanh)** | 21st.dev Registry | [`motionsites-prompts/dev21-minhxthanh-shader-background`](motionsites-prompts/dev21-minhxthanh-shader-background) |
| 31 | **Scroll Morph Hero (by prashantsom75)** | 21st.dev Registry | [`motionsites-prompts/dev21-prashantsom75-scroll-morph-hero`](motionsites-prompts/dev21-prashantsom75-scroll-morph-hero) |
| 32 | **Cinematic Landing Hero (by easemize)** | 21st.dev Registry | [`motionsites-prompts/dev21-easemize-cinematic-landing-hero`](motionsites-prompts/dev21-easemize-cinematic-landing-hero) |
| 33 | **Cinematic Landing Hero (by user_2xJxXqdwWohYrdd6fiMYrS9hbmO)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2xJxXqdwWohYrdd6fiMYrS9hbmO-cinematic-landing-hero`](motionsites-prompts/dev21-user_2xJxXqdwWohYrdd6fiMYrS9hbmO-cinematic-landing-hero) |
| 34 | **Gooey Text Morphing (by user_victorwelander)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_victorwelander-gooey-text-morphing`](motionsites-prompts/dev21-user_victorwelander-gooey-text-morphing) |
| 35 | **Aurora Background (by user_aceternity)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_aceternity-aurora-background`](motionsites-prompts/dev21-user_aceternity-aurora-background) |
| 36 | **Shape Landing Hero (by user_2rQ1QHrJyxpmWMHhqhANzWMc64n)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-shape-landing-hero`](motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-shape-landing-hero) |
| 37 | **Zoom Parallax (by sshahaider)** | 21st.dev Registry | [`motionsites-prompts/dev21-sshahaider-zoom-parallax`](motionsites-prompts/dev21-sshahaider-zoom-parallax) |
| 38 | **Gallery4 (by user_2rguB0QxcSITG2Y7ivePFsKsUU6)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rguB0QxcSITG2Y7ivePFsKsUU6-gallery4`](motionsites-prompts/dev21-user_2rguB0QxcSITG2Y7ivePFsKsUU6-gallery4) |
| 39 | **Bento Grid (by user_aceternity)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_aceternity-bento-grid`](motionsites-prompts/dev21-user_aceternity-bento-grid) |
| 40 | **Feature Carousel (by larsen66)** | 21st.dev Registry | [`motionsites-prompts/dev21-larsen66-feature-carousel`](motionsites-prompts/dev21-larsen66-feature-carousel) |
| 41 | **Bento Grid (by user_2rQ1QHrJyxpmWMHhqhANzWMc64n)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-bento-grid`](motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-bento-grid) |
| 42 | **Cpu Architecture (by user_2nElBLvklOKlAURm6W1PTu6yYFh)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2nElBLvklOKlAURm6W1PTu6yYFh-cpu-architecture`](motionsites-prompts/dev21-user_2nElBLvklOKlAURm6W1PTu6yYFh-cpu-architecture) |
| 43 | **Features 8 (by user_2tUYFzCDCVfrMrVC3TfB9DUBAyx)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2tUYFzCDCVfrMrVC3TfB9DUBAyx-features-8`](motionsites-prompts/dev21-user_2tUYFzCDCVfrMrVC3TfB9DUBAyx-features-8) |
| 44 | **Hero 195 (by shadcnblockscom)** | 21st.dev Registry | [`motionsites-prompts/dev21-shadcnblockscom-hero-195`](motionsites-prompts/dev21-shadcnblockscom-hero-195) |
| 45 | **Hero 195 1 (by shadcnblockscom)** | 21st.dev Registry | [`motionsites-prompts/dev21-shadcnblockscom-hero-195-1`](motionsites-prompts/dev21-shadcnblockscom-hero-195-1) |
| 46 | **Ai Prompt Box (by user_2xJxXqdwWohYrdd6fiMYrS9hbmO)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2xJxXqdwWohYrdd6fiMYrS9hbmO-ai-prompt-box`](motionsites-prompts/dev21-user_2xJxXqdwWohYrdd6fiMYrS9hbmO-ai-prompt-box) |
| 47 | **Ai Prompt Box (by easemize)** | 21st.dev Registry | [`motionsites-prompts/dev21-easemize-ai-prompt-box`](motionsites-prompts/dev21-easemize-ai-prompt-box) |
| 48 | **Agent Plan (by user_2tkbBPFWYn8YMjZNHwgIuP3yzvd)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2tkbBPFWYn8YMjZNHwgIuP3yzvd-agent-plan`](motionsites-prompts/dev21-user_2tkbBPFWYn8YMjZNHwgIuP3yzvd-agent-plan) |
| 49 | **Ai Voice Input (by user_2rQ1QHrJyxpmWMHhqhANzWMc64n)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-ai-voice-input`](motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-ai-voice-input) |
| 50 | **Animated Ai Chat (by user_2ra80vx0iKMyQWJ5AESmNfFbCHD)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2ra80vx0iKMyQWJ5AESmNfFbCHD-animated-ai-chat`](motionsites-prompts/dev21-user_2ra80vx0iKMyQWJ5AESmNfFbCHD-animated-ai-chat) |
| 51 | **Text Shimmer (by user_motion_primitives)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_motion_primitives-text-shimmer`](motionsites-prompts/dev21-user_motion_primitives-text-shimmer) |
| 52 | **Ai Loader (by beratberkayg)** | 21st.dev Registry | [`motionsites-prompts/dev21-beratberkayg-ai-loader`](motionsites-prompts/dev21-beratberkayg-ai-loader) |
| 53 | **V0 Ai Chat (by user_2rQ1QHrJyxpmWMHhqhANzWMc64n)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-v0-ai-chat`](motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-v0-ai-chat) |
| 54 | **Glowing Ai Chat Assistant (by muhammad-binsalman)** | 21st.dev Registry | [`motionsites-prompts/dev21-muhammad-binsalman-glowing-ai-chat-assistant`](motionsites-prompts/dev21-muhammad-binsalman-glowing-ai-chat-assistant) |
| 55 | **Shining Text (by user_2rWolCuRnJW3DRiuQ5JHrl5kj8a)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rWolCuRnJW3DRiuQ5JHrl5kj8a-shining-text`](motionsites-prompts/dev21-user_2rWolCuRnJW3DRiuQ5JHrl5kj8a-shining-text) |
| 56 | **Chatgpt Prompt Input (by easemize)** | 21st.dev Registry | [`motionsites-prompts/dev21-easemize-chatgpt-prompt-input`](motionsites-prompts/dev21-easemize-chatgpt-prompt-input) |
| 57 | **Liquid Glass Button (by designali-in)** | 21st.dev Registry | [`motionsites-prompts/dev21-designali-in-liquid-glass-button`](motionsites-prompts/dev21-designali-in-liquid-glass-button) |
| 58 | **Liquid Glass (by suraj-xd)** | 21st.dev Registry | [`motionsites-prompts/dev21-suraj-xd-liquid-glass`](motionsites-prompts/dev21-suraj-xd-liquid-glass) |
| 59 | **Sign In Flow 1 (by nubmaster4568)** | 21st.dev Registry | [`motionsites-prompts/dev21-nubmaster4568-sign-in-flow-1`](motionsites-prompts/dev21-nubmaster4568-sign-in-flow-1) |
| 60 | **Theme Toggle (by user_ayushmxxn)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_ayushmxxn-theme-toggle`](motionsites-prompts/dev21-user_ayushmxxn-theme-toggle) |
| 61 | **Interactive Hover Button (by user_magicui)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_magicui-interactive-hover-button`](motionsites-prompts/dev21-user_magicui-interactive-hover-button) |
| 62 | **Rainbow Button (by user_magicui)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_magicui-rainbow-button`](motionsites-prompts/dev21-user_magicui-rainbow-button) |
| 63 | **Neon Button (by user_2sAqoiqsju5FgfPpyDU67flpOxe)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2sAqoiqsju5FgfPpyDU67flpOxe-neon-button`](motionsites-prompts/dev21-user_2sAqoiqsju5FgfPpyDU67flpOxe-neon-button) |
| 64 | **Gradient Button (by user_2nElBLvklOKlAURm6W1PTu6yYFh)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2nElBLvklOKlAURm6W1PTu6yYFh-gradient-button`](motionsites-prompts/dev21-user_2nElBLvklOKlAURm6W1PTu6yYFh-gradient-button) |
| 65 | **Gradient Menu (by minhxthanh)** | 21st.dev Registry | [`motionsites-prompts/dev21-minhxthanh-gradient-menu`](motionsites-prompts/dev21-minhxthanh-gradient-menu) |
| 66 | **Circular Testimonials (by maxim.bort.devel)** | 21st.dev Registry | [`motionsites-prompts/dev21-maxim.bort.devel-circular-testimonials`](motionsites-prompts/dev21-maxim.bort.devel-circular-testimonials) |
| 67 | **Testimonials With Marquee (by user_2nElBLvklOKlAURm6W1PTu6yYFh)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2nElBLvklOKlAURm6W1PTu6yYFh-testimonials-with-marquee`](motionsites-prompts/dev21-user_2nElBLvklOKlAURm6W1PTu6yYFh-testimonials-with-marquee) |
| 68 | **3d Testimonails (by sean0205)** | 21st.dev Registry | [`motionsites-prompts/dev21-sean0205-3d-testimonails`](motionsites-prompts/dev21-sean0205-3d-testimonails) |
| 69 | **Animated Testimonials (by user_aceternity)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_aceternity-animated-testimonials`](motionsites-prompts/dev21-user_aceternity-animated-testimonials) |
| 70 | **Stagger Testimonials (by user_2rV0b4mwh6SKrMK7lUyQUkzEa92)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rV0b4mwh6SKrMK7lUyQUkzEa92-stagger-testimonials`](motionsites-prompts/dev21-user_2rV0b4mwh6SKrMK7lUyQUkzEa92-stagger-testimonials) |
| 71 | **Testimonial V2 (by avanishverma4)** | 21st.dev Registry | [`motionsites-prompts/dev21-avanishverma4-testimonial-v2`](motionsites-prompts/dev21-avanishverma4-testimonial-v2) |
| 72 | **Testimonial Cards (by user_2rV0b4mwh6SKrMK7lUyQUkzEa92)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rV0b4mwh6SKrMK7lUyQUkzEa92-testimonial-cards`](motionsites-prompts/dev21-user_2rV0b4mwh6SKrMK7lUyQUkzEa92-testimonial-cards) |
| 73 | **Unique Testimonial (by jatin-yadav05)** | 21st.dev Registry | [`motionsites-prompts/dev21-jatin-yadav05-unique-testimonial`](motionsites-prompts/dev21-jatin-yadav05-unique-testimonial) |
| 74 | **Animated Cards Stack (by user_2sdAd21yCZlZRkVtZyf4K8ogkBh)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2sdAd21yCZlZRkVtZyf4K8ogkBh-animated-cards-stack`](motionsites-prompts/dev21-user_2sdAd21yCZlZRkVtZyf4K8ogkBh-animated-cards-stack) |
| 75 | **Pricing Section 4 (by uilayout.contact)** | 21st.dev Registry | [`motionsites-prompts/dev21-uilayout.contact-pricing-section-4`](motionsites-prompts/dev21-uilayout.contact-pricing-section-4) |
| 76 | **Pricing (by user_Codehagen)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_Codehagen-pricing`](motionsites-prompts/dev21-user_Codehagen-pricing) |
| 77 | **Pricing Interaction (by user_2rmPdOT0hL8MtSnYm8IpqqrYTVg)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rmPdOT0hL8MtSnYm8IpqqrYTVg-pricing-interaction`](motionsites-prompts/dev21-user_2rmPdOT0hL8MtSnYm8IpqqrYTVg-pricing-interaction) |
| 78 | **Animated Glassy Pricing (by easemize)** | 21st.dev Registry | [`motionsites-prompts/dev21-easemize-animated-glassy-pricing`](motionsites-prompts/dev21-easemize-animated-glassy-pricing) |
| 79 | **Pricing Section (by user_aymanch-03)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_aymanch-03-pricing-section`](motionsites-prompts/dev21-user_aymanch-03-pricing-section) |
| 80 | **Creative Pricing (by user_2rQ1QHrJyxpmWMHhqhANzWMc64n)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-creative-pricing`](motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-creative-pricing) |
| 81 | **Dark Gradient Pricing (by user_2rV0b4mwh6SKrMK7lUyQUkzEa92)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rV0b4mwh6SKrMK7lUyQUkzEa92-dark-gradient-pricing`](motionsites-prompts/dev21-user_2rV0b4mwh6SKrMK7lUyQUkzEa92-dark-gradient-pricing) |
| 82 | **Single Pricing Card (by sshahaider)** | 21st.dev Registry | [`motionsites-prompts/dev21-sshahaider-single-pricing-card`](motionsites-prompts/dev21-sshahaider-single-pricing-card) |
| 83 | **Pricing (by sshahaider)** | 21st.dev Registry | [`motionsites-prompts/dev21-sshahaider-pricing`](motionsites-prompts/dev21-sshahaider-pricing) |
| 84 | **Pricing Section With Comparison (by user_tommyjepsen)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_tommyjepsen-pricing-section-with-comparison`](motionsites-prompts/dev21-user_tommyjepsen-pricing-section-with-comparison) |
| 85 | **Particle Text Effect (by xubohuah)** | 21st.dev Registry | [`motionsites-prompts/dev21-xubohuah-particle-text-effect`](motionsites-prompts/dev21-xubohuah-particle-text-effect) |
| 86 | **Typewriter (by user_danielpetho)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_danielpetho-typewriter`](motionsites-prompts/dev21-user_danielpetho-typewriter) |
| 87 | **Vapour Text Effect (by jatin-yadav05)** | 21st.dev Registry | [`motionsites-prompts/dev21-jatin-yadav05-vapour-text-effect`](motionsites-prompts/dev21-jatin-yadav05-vapour-text-effect) |
| 88 | **Reveal Images (by user_hari)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_hari-reveal-images`](motionsites-prompts/dev21-user_hari-reveal-images) |
| 89 | **Text Reveal (by user_magicui)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_magicui-text-reveal`](motionsites-prompts/dev21-user_magicui-text-reveal) |
| 90 | **Link Preview (by user_aceternity)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_aceternity-link-preview`](motionsites-prompts/dev21-user_aceternity-link-preview) |
| 91 | **Text Effect (by user_motion_primitives)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_motion_primitives-text-effect`](motionsites-prompts/dev21-user_motion_primitives-text-effect) |
| 92 | **Hand Writing Text (by user_2rQ1QHrJyxpmWMHhqhANzWMc64n)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-hand-writing-text`](motionsites-prompts/dev21-user_2rQ1QHrJyxpmWMHhqhANzWMc64n-hand-writing-text) |
| 93 | **Animated Text Cycle (by user_2ue7h0Xyywk5R5wzsNX1W8bcJq3)** | 21st.dev Registry | [`motionsites-prompts/dev21-user_2ue7h0Xyywk5R5wzsNX1W8bcJq3-animated-text-cycle`](motionsites-prompts/dev21-user_2ue7h0Xyywk5R5wzsNX1W8bcJq3-animated-text-cycle) |
